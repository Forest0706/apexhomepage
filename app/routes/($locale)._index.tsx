      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 container mx-auto px-6 md:px-12 flex flex-col items-start justify-center h-full">
          ...
          <div className="mt-12">
            ...
            >
              <span className="relative z-10 group-hover:text-black transition-colors duration-300">商品一覧を見る</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product) => (
              <ProductCard
                ...
                className="group"
                label={product.isNew ? '新作' : product.isPreorder ? '予約受付中' : undefined}
              />
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <h3 className="text-accent font-mono text-sm tracking-widest">コンセプト</h3>
              <h2 className="text-4xl md:text-5xl font-bold leading-tight">
                あなたのコレクションに<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-600">特別な価値を</span>
              </h2>
              <p className="text-gray-400 leading-relaxed text-lg">
                APEX TOYSは、限定特典グッズと高品質フィギュアを提供する専門店です。
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10">
                <div>
                  ...
                  <div className="text-xs text-gray-500 uppercase tracking-wider">数量限定商品</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-white mb-2">高品質</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wider">厳選された品質</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-white mb-2">特典</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wider">限定特典付き</div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="aspect-[4/5] bg-gray-900 rounded-lg overflow-hidden border border-white/10">
                 ...
                 <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black to-transparent">
                   <p className="font-mono text-xs text-accent">限定商品 // 高品質保証</p>
                 </div>
              </div>
            </div>
          </div>
