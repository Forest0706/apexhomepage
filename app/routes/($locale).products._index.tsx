...
export default function AllProducts() {
  ...
  return (
    <div className="h-screen w-full bg-white overflow-y-scroll snap-y snap-mandatory hiddenScroll relative">
      {/* Fixed Background */}
      <div
      ...
      {/* Navigation Overlay */}
      <div className="fixed top-0 left-0 w-full h-20 bg-gradient-to-b from-white/80 to-transparent z-40 pointer-events-none" />
      ...
      {products.map((product, index) => (
        ...
        >
          ...
          <div className="relative z-10 w-full bg-gradient-to-t from-white via-white/90 to-transparent pt-32 pb-16 px-6 flex flex-col items-center text-center space-y-4 product-content opacity-0 translate-y-[50px] transition-none">
            <h2 className="text-accent font-mono text-sm tracking-[0.5em] uppercase">
              COLLECTION 0{index + 1}
            </h2>
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 tracking-tight uppercase drop-shadow-sm">
              {product.title}
            </h1>
            ...
            <Link
              ...
              className="mt-6 px-10 py-3 border border-gray-300 bg-white/50 backdrop-blur-md text-gray-900 font-mono tracking-widest hover:bg-gray-900 hover:text-white transition-all duration-300"
            >
              詳細を見る
            </Link>
          </div>
